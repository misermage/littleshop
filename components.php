...
<head>
	<!-- Basic Meta Tags -->
  <meta charset="utf-8">
  <title>UPTAKE2 - magazine template by entiri</title>
...
<body>
      ...
      <div class="container">
        <div class="row"> 
          ...
          <div class="col-md-3 col-md-offset-1 col-sm-4 col-sm-offset-0">
            ...
            <!-- Shopping Cart Input -->
            <div class="input-group">
              <input type="text" class="form-control" placeholder="No items">
              <span class="input-group-btn">
        ...
        <div class="container"> 
          ...
          <ul class="nav navbar-nav" id="nav">
            <li><a href="index.html" title="">Home</a>
              <!-- Submenu -->
              <ul>
                <li><a href="http://tiny.cc/lt774x" title="">Submenu 01</a></li>
                <li><a href="#" title="">Submenu 02</a></li>
                <li><a href="#" title="">Submenu 03</a></li>
                <li class="selected"><a href="#" title="">Submenu 04 Selected</a></li>           
              </ul>
              <!-- Submenu End --> 
            </li>
            ...
            <li><a href="shop.html" title="">Shop</a>
              <!-- Submenu -->
              <ul>
                <li><a href="product-list.html" title="">Product List</a></li>
                <li><a href="product-detail.html" title="">Product Detail</a></li>
                <li><a href="my-account.html" title="">My Account</a></li> 
                <li><a href="checkout.html" title="">Checkout</a></li>           
              </ul>
              <!-- Submenu End --> 
            </li>
            <li class="selected"><a href="components.html" title="">Components</a></li>   
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <hr>
        <h1>GOOD DESIGN IS AS LITTLE DESIGN</h1>
        <h2>GOOD DESIGN IS AS LITTLE DESIGN</h2>
        <h3>GOOD DESIGN IS AS LITTLE DESIGN</h3>
        <h4>GOOD DESIGN IS AS LITTLE DESIGN</h4>
        <h5>GOOD DESIGN IS AS LITTLE DESIGN</h5>
        <h6>GOOD DESIGN IS AS LITTLE DESIGN</h6>
        <hr>
        <p>Lendrerit nibh, qrsus eget. Integer porvitae felinibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibsta nisl vitae felim tae felis rutrum ut mollgol lgnissim his.</p>
        <p>Garsus eget. Integer porvitae felinibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibsta nisl vitae felim tae felis rutrum ut mollgol.</p>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <blockquote>Lendrerit nibh, qrsus eget. Integer porvitae felinibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibh, quis faunissim hendrerit nibsta nisl vitae felim tae felis rutrum ut mollgol lgnissim his.</blockquote>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="about-us">
          <h3><i class="fa fa-shopping-cart"></i> What is Uptake Store?</h3>
          <p>Claritas est etiam processus dynamicus, and mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc. Parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima.</p>
      ...
      <div class="col-md-4">
        <div class="about-us">
          <h3><i class="fa fa-book"></i> Company History</h3>
          <p>Claritas est etiam processus dynamicus, and mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc. Parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima.</p>
          <div class="space30"></div> 
        </div> 
      </div>   
      ...
      <div class="col-md-4">
        <div class="about-us">
          <h3><i class="fa fa-rocket"></i> Our Visions</h3>
          <p>Claritas est etiam processus dynamicus, and mutationem consuetudium lectorum. Mirum est notare quam littera gothica, quam nunc. Parum claram, anteposuerit litterarum formas humanitatis per seacula quarta decima.</p>
          <div class="space30"></div> 
        </div>   
      </div> 
      ...
      <div class="col-md-12">
        ...
        <div class="tabbable">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#tab1-1" data-toggle="tab"><i class="fa fa-pencil"></i>Tab 1</a></li>
            <li><a href="#tab1-2" data-toggle="tab"><i class="fa fa-cloud-download"></i>Tab 2</a></li>
            <li><a href="#tab1-3" data-toggle="tab"><i class="fa fa-folder-open"></i>Tab 3</a></li>
          </ul>
        ...
        <div class="panel-group" id="accordion">
          ...
          <div class="panel panel-default">
            ...
            <div id="collapseTwo" class="panel-collapse collapse">
              <div class="panel-body">
                <img src="img/accordion/02.jpg" alt="">   
                Zemerav reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of the calom.
                <br><br>
          ...
          <div class="panel panel-default">
            ...
            <div id="collapseThree" class="panel-collapse collapse">
              <div class="panel-body">
                <img src="img/accordion/03.jpg" alt="">
                Letood truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of the calom.
                <br><br>
                Gliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor bigh life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="service">
            ...
            <h3><a href="#">Powerful Features</a></h3>
            <p>Cursus eget. Integer porta nisl vitae felis rutrum ut mollgnissim hendreSed dignissim hendrerit nibh, quis faucibus erat cursus.</p>
          </div> 
        </div>  
        <div class="col-md-4">
          <div class="service">
            ...
            <h3><a href="#">Complex Admin</a></h3>
            <p>Gnissim hendrerit nibh, qrsus eget. Integer porvitae felista nisl vitae felim tae felis rutrum ut mollgol lgnissim his.</p>
          </div> 
        </div> 
        <div class="col-md-4">
          <div class="service">
            ...
            <h3><a href="#">E-shop Ready</a></h3>
            <p>Int curletis rusus eger porta nisl vitae fetrum ut mollgn isteger porteta nisim herta nisl vitae felis rutrum ut mollgndre.</p>
          </div> 
        </div> 
      </div>    
      <!-- Services End --> 
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="buttons-page">
          <p>
            <button type="button" class="btn btn-default btn-xs">Extra Small Default</button>
            
            <button type="button" class="btn btn-default btn-sm">Small Default Button</button>
            
            <button type="button" class="btn btn-default"><i class="fa fa-bell"></i>Default Button</button>
            
            <button type="button" class="btn btn-default btn-lg"><i class="fa fa-globe"></i>Large Default</button>
          </p>   
          <p>
            <button type="button" class="btn btn-primary btn-xs">Extra Small Primary</button>
            
            <button type="button" class="btn btn-primary btn-sm">Small Primary Button</button>
            
            <button type="button" class="btn btn-primary"><i class="fa fa-bell"></i>Primary Button</button>
  
            <button type="button" class="btn btn-primary btn-lg"><i class="fa fa-globe"></i>Large Primary</button>
          </p> 
        </div>  
        <!-- Buttons End -->
        ...
        <div class="progress-bar-shortcode">
          <div class="progress">          
            <div class="progress-bar progress-bar-success" role="progressbar" data-percentage="80">
              <span class="progress-bar-span">Webdesign 82%</span>
            </div>
          </div>  

          <div class="progress">         
            <div class="progress-bar progress-bar-success" role="progressbar" data-percentage="60">
              <span class="progress-bar-span">Print 70%</span>
            </div>
          </div>  

          <div class="progress">          
            <div class="progress-bar progress-bar-success" role="progressbar" data-percentage="90">
              <span class="progress-bar-span">WooCommerce 90%</span>
            </div>
          </div>  

          <div class="progress">          
            <div class="progress-bar progress-bar-success" role="progressbar" data-percentage="100">
              <span class="progress-bar-span">WordPress 100%</span>
            </div>
          </div>  
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <ul class="list-a">
          <li>
            <i class="fa fa-trophy"></i> Le Aorem Ipsum ainsi obe seng elit.
          </li><li>  
            <i class="fa fa-road"></i> Al contrario di qudio, quis frigila.
          </li><li>  
            <i class="fa fa-magnet"></i> Sopravvissuto solo velor iaculis.
          </li><li>  
            <i class="fa fa-puzzle-piece"></i> Contrairement à Lorem daliquet mols.
          </li><li>  
            <i class="fa fa-ambulance"></i> On sait depuis travr cotàne opinion.
          </li><li>  
            <i class="fa fa-star"></i> Sait depuis lohue gravida porttitor.
          </li>
        </ul>
      ...
      <div class="col-md-4">
        ...
        <ul class="list-a">
          <li>
            <i class="fa fa-check"></i> Sopravvissuto nolo velor iaculis.
          </li><li>  
            <i class="fa fa-check"></i> Le Aorem Ipainsinu ne seeng elit.
          </li><li>  
            <i class="fa fa-check"></i> Contrair Lorem naliquet mollis.
          </li><li>  
            <i class="fa fa-check"></i> On sait travailler cotà opinion.
          </li><li>  
            <i class="fa fa-check"></i> Al contri quaon enodio, ringilla.
          </li><li>  
            <i class="fa fa-check"></i> Sait depdue gravida porttitor.
          </li>
        </ul>
        <div class="space20"></div> 
      </div>
      <div class="col-md-4">
        <h6>List with Links</h6>
        <ul class="list-b">
          <li>
            <a href="#"><i class="fa fa-bug"></i> Le Aorem Ipsum ainsi obe seng elit.</a>
          </li><li>  
            <a href="#"><i class="fa fa-shield"></i> Al contrario di qudio, quis frigila.</a>
          </li><li>  
            <a href="#"><i class="fa fa-fire"></i> Sopravvissuto solo velor iaculis.</a>
          </li><li>  
            <a href="#"><i class="fa fa-legal"></i> Contrairement à Lorem daliquet mols.</a>
          </li><li>  
            <a href="#"><i class="fa fa-moon-o"></i> On sait depuis travr cotàne opinion.</a>
          </li><li>  
            <a href="#"><i class="fa fa-thumbs-up"></i> Sait depuis lohue gravida porttitor.</a>
          </li>
        </ul>
        <div class="space20"></div> 
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4">    
        <div class="box-white">
          <h4>Box Title</h4>
          <p>
            Lacus augue, tincidunt? Placerat, aliquam ac a natoque sagittis, porta tincidunt vut velit platea amet? Phasellus turpis risus? Odio tincidunt! Nunc adipiscing a enim platea sociis magna! Odio amet et? Ut amet odio aliquam enim nec purus arcu, habitasse et dis nisi. Etiam pulvinar pulvinar porttitor sed vut porta lacus magna ultrices elementum
          </p>  
        </div>
      </div>   
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <img src="img/advertisment/01.jpg" alt="">
      </div> 
    </div> 
  </div> 
  ...
  <div class="footer">   
    <div class="white-background">  
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-3 col-sm-6">
            <h4>NEWSLETTER</h4>
            Be the first to know about Uptake special offers, new product lauches.
            <div class="space20"></div>  
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <button class="btn" type="button"><i class="fa fa-envelope"></i></button>
              </span>
            </div>
    ...
    <div class="container">
      ...
      <div class="row copyright-container">
        ...
        <div class="col-md-6">
          <div class="copyright">
            &copy; 2014 Uptake. Designed by <a href="http://www.entiri.com" rel="external">entiri</a><br>
            <a class="link-2" href="http://themeforest.net/user/entiri/?ref=entiri" rel="external">http://themeforest.net/user/entiri</a>
          </div>
        </div>
        <div class="col-md-5">
